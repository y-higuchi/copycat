...
abstract class BaseState implements State {
  ...
  public ListenableFuture<AppendEntriesResponse> appendEntries(final AppendEntriesRequest request) {
    return executor.submit(new Callable<AppendEntriesResponse>() {
      @Override
   ...
   */
  protected ListenableFuture<Void> compactLog() {
  ...
  public ListenableFuture<RequestVoteResponse> requestVote(RequestVoteRequest request) {
    return Futures.immediateFuture(handleRequestVote(request));
  }
  ...
  public ListenableFuture<SubmitCommandResponse> submitCommand(SubmitCommandRequest request) {
    return Futures.immediateFuture(new SubmitCommandResponse(request.id(), "Not the leader"));
  }
